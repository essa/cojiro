...
Feature: Lookup url
  As a curator
  I want to lookup a url
  So that I can add it to my thread
  ...
  Scenario: Blank data for 404 URL
    ...
    And I enter the url "http://google.com/404.html" into the dialog box
    And I click "Go!"
  ...
  Scenario: Embedly data for valid video URL
    When I click on "Add a link"
    And I enter the url "http://www.youtube.com/watch?v=Sgf0WcJEYz4" into the dialog box
    And I click "Go!"
    And I wait for the AJAX call to finish
  ...
  Scenario: Embedly data for valid website
    When I click on "Add a link"
    And I enter the url "http://ripplet.org/2013/04/self-grooming-and-public-transportation-if-you-cant-beat-them-create-a-space-for-them/" into the dialog box
    And I click "Go!"
    And I wait for the AJAX call to finish
  ...
  Scenario: Embedly data for valid tweet URL
    When I click on "Add a link"
    And I enter the url "https://twitter.com/tzs/status/328846992044343296" into the dialog box
    And I click "Go!"
  ...
  Scenario: Embedly data for valid photo
    When I click on "Add a link"
    And I enter the url "http://www.flickr.com/photos/ripplet/7128327045/in/set-72157629932925953" into the dialog box
    And I click "Go!"
    And I wait for the AJAX call to finish
